...
namespace cotangent
{
    public class PrintSettings
    {
        ...
        public int OpenModeInt {
            ...
            set { OpenMeshMode newmode = (OpenMeshMode)value;
        ...
        public int BedSizeXMM {
            ...
            set { if (bed_size_x != value) { bed_size_x = value; setting_modified(false, true); CC.NotifyBedSizeModified(); } }
        }
        ...
        public int BedSizeYMM {
            ...
            set { if (bed_size_y != value) { bed_size_y = value; setting_modified(false, true); CC.NotifyBedSizeModified(); } }
        }
        ...
        public int BedSizeZMM {
            ...
            set { if (bed_size_z != value) { bed_size_z = value; setting_modified(false, true); CC.NotifyBedSizeModified(); } }
        }
