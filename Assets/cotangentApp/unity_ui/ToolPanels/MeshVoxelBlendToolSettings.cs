...
public class MeshVoxelBlendToolSettings : BaseToolSettings<MeshVoxelBlendTool>
{
    InputField blendPower;
    InputField blendDistance;
    ...
    {
        blendPower = base.RegisterFloatInput("BlendPowerInput", "blend_power", new Interval1d(0.001f, 50000.0f));
        blendDistance = base.RegisterFloatInput("BlendDistanceInput", "blend_distance", new Interval1d(0.001f, 50000.0f));
